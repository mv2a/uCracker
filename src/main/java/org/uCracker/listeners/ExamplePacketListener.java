...
public class ExamplePacketListener implements uCrackerPacketListener {
	...
	private static final String EXAMPLE_HOST = "jenkins.internal.ibboost.com";
	private static final String EXAMPLE_CREDENTIAL_PATTERN = "j_username=.*&j_password=.*(&.*)*";

	private final ArgsPresentator argsPresentator;
